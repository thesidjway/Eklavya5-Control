...
void VxPid::reverseCallback(const geometry_msgs::Twist::ConstPtr& msg) {
...
void VxPid::brakeCallback(const geometry_msgs::Twist::ConstPtr& msg) {
...
void VxPid::implementPid(int argc, char** argv)
{
	...
	ros::Subscriber _Subscriber = nh_.subscribe<geometry_msgs::Twist>("target_pose", 5,&VxPid::vxTargetUpdateCallback, this);
	ros::Subscriber _Subscriber = nh_.subscribe<geometry_msgs::Twist>("brake_val", 5,&VxPid::brakeCallback, this);
	//ros::Subscriber Alpha_Actual_Subscriber = nh_.subscribe<std_msgs::Float64>("alpha_val_actual" , 5 , Alpha_actual_callback);
	ros::Subscriber Encoder_Subscriber = nh_.subscribe<geometry_msgs::Twist>("reverse_val", 5, &VxPid::reverseCallback, this);
